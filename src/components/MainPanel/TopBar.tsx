...
import { ItemDisplay, ItemFilter, WeddingFile } from '../../utils/types';

type Props = {
  itemDisplay: ItemDisplay;
  setItemDisplay: React.Dispatch<React.SetStateAction<ItemDisplay>>;
...
const TopBar = ({
  ...
  const showGrid = () => {
    setItemDisplay('carousel');
  };

  const basicButtonClass =
    'text-sm font-medium text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mr-2';
  ...
  return (
    ...
    >
      ...
      <button className={basicButtonClass} onClick={() => setFiles([])}>
        <svg
          className="w-6 h-6 text-gray-800 dark:text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div>
        <button className={basicButtonClass} onClick={() => setFilter('all')}>
          <svg
            className="w-6 h-6 text-gray-800 dark:text-white"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
